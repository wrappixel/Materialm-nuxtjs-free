    ...
    <v-card elevation="10" class="bg-lightsecondary">
        <v-card-item>
            ...
            <v-row class="d-flex justify-space-between align-end mt-5">
                <v-col cols="7" xl="5" class="mb-1 pe-0">
                    <h2 class="text-h2 mb-3">$6,280</h2>
                    <span class="text-subtitle-2 rounded-pill px-3 py-1 lh-normal text-muted border border-muted font-weight-medium">+18% last month</span>
                </v-col>
                <v-col cols="5" xl="5">
